...
class OPCommands {
    constructor(client, options) {
        ...
        if (!options.commandsDir) throw new Error("[OPCommands] Missing commands' directory parameter in options.");
        if (!options.eventsDir) throw new Error("[OPCommands] Missing events' directory parameter in options.");
        this.client = client;
    ...
    async setBotOwner(owner) {
        ...
        if (owner instanceof Array) return this.client.owners = owner;
